...
/**
 * @brief Функция для добавления нового пользователя в базу данных с параметрами - айди, имя, вес, прогресс
 *
...
/**
 * @brief Функция для обновления веса пользователя в базе данных - пользователь вводит свой вес в самом начале
 *
 * @param db Указатель на базу данных SQLite.
...
/**
 * @brief Функция для обновления прогресса пользователя в базе данных - старый вес уменьшается на введеное число
 *
 * @param db Указатель на базу данных SQLite.
